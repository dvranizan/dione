...
FILES = globals.c font.c logging.c fps.c world.c main.c objects.c draw.c loader.c build.c update.c camera.c kernel.c listen.c console.c bezier.c windower.c
